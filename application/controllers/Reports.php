...
/*
    ...
    public function export_issue(){
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V10', "Net of Vat");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W10', "Supplier");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC10', "Department");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG10', "Purpose");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AK10', "End Use");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AO10', "Frequency");
            $pr_cost= array();
            $wh_cost=array();
            $wh_wo_cost=0;
            $pr_wo_cost=0;
