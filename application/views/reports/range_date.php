							...
							<?php if(!empty($head)){ ?>
								...
								<div id="printableArea">	
									...
									<table class="table table-hover table-bordered">
										<thead>
											<tr>
												<td width="20%" align="center"><strong>Item Part No.</strong></td>
												<td width="60%" align="left"><strong>Item Description</strong></td>
												<td width="20%" align="center"><strong>Avail. Qty</strong></td>
											</tr>
										</thead>
										<tbody>
											...
											<tr>
												...
												<td align="left"><strong><?php echo $h['item']?></strong></td>
