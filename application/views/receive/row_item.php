 ...
 <tr id='item_row<?php echo $list['count']; ?>'>  
    ...
    <td style="padding: 0px "><textarea  rows="3" type = "text" name = "item[]" id="itemlist_<?php echo $list['count']; ?>" style = "text-align:center;width:100%;border:1px transparent;"><?php echo $list['item']; ?></textarea></td>
     <td style="padding: 0px "><input type = "text" name = "brand[]" id="brandlist_<?php echo $list['count']; ?>" style = "text-align:center;width:100%;border:1px transparent;" value="<?php echo $list['brand']; ?>"></td>
