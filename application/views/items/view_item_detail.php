										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													?>
													<a href="<?php echo base_url(); ?>index.php/reports/stock_card_new/<?php echo $item; ?>/<?php echo $supplier;?>/<?php echo $cat;?>/<?php echo $brand;?>/null" target = "_blank" class="btn btn-primary" title="STOCK CARD"><span class="fa fa-list-alt"></span></a>
												</td>
											</tr>
											<?php }  
											} else { ?>
