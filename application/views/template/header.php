...
<style type="text/css">	
	...
	.two {
	  z-index: 1;
	  border-radius: 10px;
	  background-image:  linear-gradient(to top right, #ff3900 0%, #ffc100 100%);
	...
	.itemSubColor2{
		background: linear-gradient(40deg,#303f9f, #45cafc,#303f9f);
		padding:20px 0px;
		background-size: 200% auto;
		transition: 1s;
	}
	...
	.delete_but{
		right:20px;top: 65px;position:absolute;opacity: 0.7
	}
	.btn-danger:hover{
		opacity: 1.0
	}
